/*OWSSTDBAGO203.ServSuite... Test3 Environment Scripts Combined*/
/*OWSSTDBAGO203 = Live*/
/*OWSSDDBO246 = Replica1*/
...
/*********************************************************************************************************/
/*********************************************************************************************************/
:Connect OWSSTDBAGO203

PRINT 'Connected to OWSSTDBAGO203';
PRINT GETDATE();
PRINT '';

PRINT 'Beginning Test3 Database Refresh on OWSSTDBAGO203';
PRINT GETDATE();
PRINT '';
...
PRINT 'Disable SQL Agent Job "DatabaseBackup - USER_DATABASES - LOG" on OWSSTDBAGO203';
PRINT 'Disable SQL Agent Job "SQL Backup - DDBoost - TLOG" on OWSSTDBAGO203';
PRINT GETDATE();
PRINT '';
USE msdb ;
...
PRINT '';
PRINT '';
PRINT 'Restore Integrated Test Databases on OWSSTDBAGO203';
PRINT GETDATE();
...
PRINT 'Connected to OWSSDDBO246';
PRINT GETDATE();
PRINT '';
...
PRINT '';
PRINT '';
PRINT 'Replica1 SQL Server Database Refresh on OWSSDDBO246';
PRINT GETDATE();
...
PRINT 'Recover Live databases on OWSSTDBAGO203';
PRINT GETDATE();
PRINT '';
...
PRINT 'Join AlwaysOn databases to BOSS_AG1 on OWSSDDBO246';
PRINT GETDATE();
PRINT '';
...
PRINT 'Enabled SQL Agent Job "SQL Backup - DDBoost - TLOG" on OWSSTDBAGO203';
PRINT 'Leave SQL Agent Job "DatabaseBackup - USER_DATABASES - LOG" disabled on OWSSTDBAGO203';
PRINT GETDATE();
PRINT '';
USE [msdb];
EXEC dbo.sp_update_job
...
USE ServSuiteWBProgram;
UPDATE tlinks
SET linkurl = 'https://Test3-servsuite.rollins.com/fileserver/fileupload.aspx'
WHERE linkid = 339;
...
--Removed Round 1 drops because they have moved to production
*/
...
PRINT '';
PRINT '';
PRINT 'Test3 Environment Database Refresh Complete on OWSSTDBAGO203';
PRINT 'and AlwaysOn set up on OWSSDDBO246';
PRINT GETDATE();
/*********************************************************************************************************/
/*********************************************************************************************************/
/*********************************************************************************************************/
