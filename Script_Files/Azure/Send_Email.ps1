...
try
{
    ...
    $msg.To.Add("eCommerceSupport@Rollins.com")
    $msg.CC.Add("dbaalert@rollins.com")
    $msg.CC.Add("afoster2@Rollins.com")
    $msg.CC.Add("BAkin@Rollins.com")
    $msg.CC.Add("chris.adams@rollins.com")
    $msg.CC.Add("cglover@rollins.com")
    $msg.CC.Add("MMcCormick@rollins.com")
    $msg.CC.Add("AXu@rollins.com")
    $msg.CC.Add("kjackson@rollins.com")

#    $msg.To.Add("ssubrama@rollins.com")
#    $msg.CC.Add("jaime@servsuite.net")
