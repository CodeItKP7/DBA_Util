...
$TableAz = invoke-sqlcmd -ServerInstance RWSQLMGMTH202 -Database DBA -InputFile "C:\PowerSh\Rollins\DBA_Admin\Script_Files\Azure\ecomm_sales_TEST.sql" -As DataTables;
